...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#0e0217] rounded-md z-0",
        className
      )}>
      <div className="relative flex flex-1 items-center justify-center isolate z-0">
        <motion.div
          initial={{ opacity: 0.5 }}
          ...
          className="absolute inset-auto right-1/2 h-28 w-[12rem] md:h-56 md:w-[35rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]">
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-28 w-[12rem] md:h-56 md:w-[35rem] bg-gradient-conic from-transparent via-transparent to-cyan-500 text-white [--conic-position:from_290deg_at_center_top]">
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[12rem] -translate-y-[3.5rem] bg-cyan-400 md:w-[36rem] md:-translate-y-[7rem]">
        </motion.div>
  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        id="welcome-text" className="bg-gradient-to-br from-slate-100 to-slate-100 p-5 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-6xl">
        <span className={caveat.className}>Welcome to My Personal Portfolio</span><br/>
      </motion.h1>
      <motion.div
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
